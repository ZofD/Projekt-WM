...
<div id="content">
				<div id="slogan">
					...
					Rejestracja nie powiodła się, taki użytkownik już istnieje lub podałeś błędne dane.
					<a style="text-decoration: none;" href="register.php"><input  class='login-submit' name='rejestracja' type='button' value='Spróbuj ponownie' /></a>	
</div></div></div><div>
