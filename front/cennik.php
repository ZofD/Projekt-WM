...
<!-- HEADER -->
			<div id="header">
				...
				<div class="fleft"><a href="index.php">Kino<span>URZ</span></a></div>
					<ul><?php if($_SESSION['zalogowany']){ ?> <li>Witaj <?php echo($_SESSION['login']);  echo(", ");} if($_SESSION['zalogowany']){?><a style="text-decoration: none;" href="logout.php">wyloguj</a><?php } ?></li>
